...
config = {
    ...
    "blocked_words": {
        ...
        "色情": ["色情", "成人内容", "性爱", "裸体", "淫秽", "性暗示", "性交易", "性骚扰", "性暴力", "色情网站", "强奸", "飞机杯", "操逼"],
    ...
    "OpenAI": {
        ...
        "api_key": "",
        "aliyun_url": "https://api.ppinfra.com/v3/openai",
        "aliyun_key": "",
...
def get_ai():
    if AI_drive == "aliyun":
        drive_model = "baidu/ernie-4.5-vl-28b-a3b"
...
if low_AI_deive == "aliyun":
    low_drive_model = "baidu/ernie-4.5-vl-28b-a3b"
